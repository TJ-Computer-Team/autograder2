...
urlpatterns = [
    ...
    path("verify_cf_handle/", views.start_cf_verification, name="verify_cf_handle"),
    path("check_cf_verification/", views.check_cf_verification, name="check_cf_verification"),
